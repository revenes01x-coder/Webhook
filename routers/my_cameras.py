...
# หมายเหตุ: PATCH /my/cameras/{camera_id}/status (toggle เปิด/ปิดโดยเจ้าของกล้อง) ถูกถอดออก
# แล้ว — สถานะ is_active ของกล้องตอนนี้ถูกคุมโดยระบบพาร์ทเนอร์เท่านั้น ผ่าน
# POST /partner/cameras/status (ดู routers/partner.py) เจ้าของกล้องยังดูสถานะได้ตามปกติ
# ผ่าน GET /my/cameras ด้านล่าง แค่ไม่มีสิทธิ์สั่งเปิด/ปิดเองอีกต่อไป
